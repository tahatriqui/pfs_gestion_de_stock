...
<form method="POST" action="{{ route('services.edit',$service->id) }}">
    ...
    <div class="mb-3">
      ...
      <input value="{{ $service->services }}" type="text" name="service" class="form-control border border-dark w-25 p-2" id="service" >
    </div>

    <div class="mb-3">
        <label for="bureau" class="form-label">bureau</label>
        <input value="{{ $service->bureau }}" type="text" name="bureau" class="form-control border border-dark w-25 p-2" id="bureau" >
      </div>
