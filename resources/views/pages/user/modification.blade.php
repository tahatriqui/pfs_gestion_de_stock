        ...
        <form method="POST" action="{{ route('user.edit', $user->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{ $user->nom }}" name="nom"
                    class="form-control border border-dark w-25 ps-2" id="nom">
            </div>

            <div class="mb-3">
                <label for="prenom" class="form-label">prenom</label>
                <input type="text" value="{{ $user->prenom }}" name="prenom"
                    class="form-control border border-dark w-25 ps-2 " id="prenom">
            </div>

            <div class="mb-3">
                <label for="cin" class="form-label">CIN</label>
                <input type="cin" value="{{ $user->cin }}" name="cin"
                    class="form-control border border-dark w-25 ps-2" id="cin">
            </div>

            <div class="mb-3">
                <label for="email" class="form-label">Email address</label>
                <input type="email" value="{{ $user->email }}" name="email"
                    class="form-control border border-dark w-25 ps-2" id="email">
            </div>
